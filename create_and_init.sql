...
--
-- Host: database-1.cktq4evzprzg.ap-northeast-2.rds.amazonaws.com    Database: haejo
-- ------------------------------------------------------
...
CREATE TABLE `module` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_name_module` (`name`)
...
--
/*!50003 DROP PROCEDURE IF EXISTS `insert_req` */;
...
DELIMITER ;;
CREATE DEFINER=`yun`@`%` PROCEDURE `insert_req`(IN moduleName VARCHAR(16), OUT requestId INT)
BEGIN
    INSERT INTO request (module_id)
    SELECT id FROM module WHERE name = moduleName;
...
/*!50003 DROP PROCEDURE IF EXISTS `insert_res` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`yun`@`%` PROCEDURE `insert_res`(IN requestId INT, IN `result` VARCHAR(256), IN filePath VARCHAR(256))
BEGIN
    INSERT INTO response (request_id, `result`, file_path) values (requestId, `result`, filePath);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
